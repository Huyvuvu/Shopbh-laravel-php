                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="hero__text">
                                ...
                                <a href="/anime-watching"><span>Watch Now</span> <i class="fa fa-angle-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <div class="product__item">
                                        ...
                                        <div class="product__item__text">
                                            ...
                                            <h5 class="text-muted text-lg-left">{{number_format($i->gia)}}đ</h5>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <div class="product__item">
                                        ...
                                        <div class="product__item__text">
                                            ...
                                            <h5><a href="/{{$i['id]Cat']}}/{{$i['slug']}}">{{ $i->name }}</a></h5>
                                            <h5 class="text-muted text-lg-left">{{number_format($i->gia)}}đ</h5>
                                        </div>
                                    </div>
                                </div>
