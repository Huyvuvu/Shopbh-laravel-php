...
--
-- Host: localhost:3306
-- Generation Time: Oct 12, 2024 at 06:32 AM
...
(1, 'dtdd', NULL, 'điện thoại di động', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
...
(7, 'Samsung', 1, 'Điện thoại Samsung', '2024-09-30 09:27:25', '2024-09-30 09:27:25'),
...
(1, 'Điện thoại', 'dtdd', NULL, 1, 'Mua online điện thoại, smartphone, điện thoại thông minh giá rẻ, chính hãng. Giao nhanh, đem nhiều mẫu chọn, cà thẻ tại nhà. Trả góp 0%, bảo hành tại hơn 3000 điểm toàn quốc.', 1, 0, NULL, NULL),
...
CREATE TABLE `products` (
  ...
  `th` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `idCat` int DEFAULT NULL,
  `chitiet` text COLLATE utf8mb4_general_ci,
...
(2, 'iPhone 16 Pro Max', 'iphone-16-pro-max', 'iPhone 16 Pro Max', '[\r\n{\'id\': 1, mau: \'Titan tự nhiên\'}\r\n{\'id\': 2, mau: \'Titan đen\'}\r\n{\'id\': 3, mau: \'Titan xa mạc\'}]', 'Apple', 6, 'iPhone 16 Pro Max', 'img/san-pham/iphone-16-pro-max-titan-tu-nhien-1_0-638630301808684272-750x500.jpg', 0, b'1', '2024-09-30 09:03:07', '2024-09-30 09:03:07'),
...
--
ALTER TABLE `cart`
  ADD CONSTRAINT `cart_ibfk_1` FOREIGN KEY (`idpro`) REFERENCES `product_variants` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
